...
import { Resources, defaultAppState } from 'models/app'
...
export const alertsReducer = (state: Resources = defaultAppState.alerts, action: AlertModel.AlertAction): AlertModel.Alerts => {
